  ...
  public static void TweakPartIcons()
  {
    foreach(AvailablePart p in PartLoader.LoadedPartsList)
    {
      ...
      switch(p.name)
      {
        ...
        case "kerbalism-container-radial-bigger": p.iconPrefab.transform.GetChild(0).localScale *= 1.10f; p.iconScale *= 1.10f; break;
        case "kerbalism-container-radial-huge": p.iconPrefab.transform.GetChild(0).localScale *= 1.35f; p.iconScale *= 1.35f; break;
        case "kerbalism-container-inline-375": p.iconPrefab.transform.GetChild(0).localScale *= 1.35f; p.iconScale *= 1.35f; break;
      }
      ...
      switch(p.name)
      {
        ...
        case "kerbalism-container-radial-bigger": p.title = Lib.BuildString("<size=1><color=#00000000>07</color></size>", p.title); break;
        case "kerbalism-container-radial-huge":   p.title = Lib.BuildString("<size=1><color=#00000000>08</color></size>", p.title); break;
        case "kerbalism-greenhouse":              p.title = Lib.BuildString("<size=1><color=#00000000>09</color></size>", p.title); break;
        case "kerbalism-gravityring":             p.title = Lib.BuildString("<size=1><color=#00000000>10</color></size>", p.title); break;
        case "kerbalism-activeshield":            p.title = Lib.BuildString("<size=1><color=#00000000>11</color></size>", p.title); break;
        case "kerbalism-chemicalplant":           p.title = Lib.BuildString("<size=1><color=#00000000>12</color></size>", p.title); break;
      }
    }
  }
